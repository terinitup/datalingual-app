...
export default function ComparePage() {
  const [geographyType, setGeographyType] = useState<GeographyType>('city');
  ...
  const availableToAdd = data.filter((d) => !selectedIds.includes(d.id));
